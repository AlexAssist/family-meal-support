...
def _category_for_staple(name: str) -> GroceryCategory:
    ...
    mapping: dict[str, GroceryCategory] = {
        ...
        "shredded cheese": GroceryCategory.DAIRY,
        ...
        "lettuce / salad greens": GroceryCategory.PRODUCE,
        "lettuce": GroceryCategory.PRODUCE,
        "salad greens": GroceryCategory.PRODUCE,
        "yellow onions": GroceryCategory.PRODUCE,
        "yellow onion": GroceryCategory.PRODUCE,
        ...
        "avocados": GroceryCategory.PRODUCE,
        ...
        "bell peppers": GroceryCategory.PRODUCE,
        "cucumber": GroceryCategory.PRODUCE,
        # Bakery / Bread
        "bread": GroceryCategory.BAKERY,
        "tortillas": GroceryCategory.BAKERY,
        "flour tortillas": GroceryCategory.BAKERY,
        "6-inch tortillas": GroceryCategory.BAKERY,
        ...
        # Condiments / Sauces
        "ketchup": GroceryCategory.CONDIMENTS,
        "mayonnaise": GroceryCategory.CONDIMENTS,
        "soy sauce": GroceryCategory.CONDIMENTS,
        "mustard": GroceryCategory.CONDIMENTS,
        "hot sauce": GroceryCategory.CONDIMENTS,
        "bbq sauce": GroceryCategory.CONDIMENTS,
        "salsa": GroceryCategory.CONDIMENTS,
        "soy sauce": GroceryCategory.CONDIMENTS,
        "oyster sauce": GroceryCategory.CONDIMENTS,
        "sesame oil": GroceryCategory.CONDIMENTS,
        # Meat / Seafood
        "ground chicken": GroceryCategory.MEAT_SEAFOOD,
        "ground beef": GroceryCategory.MEAT_SEAFOOD,
        "chicken breast": GroceryCategory.MEAT_SEAFOOD,
        "chicken thighs": GroceryCategory.MEAT_SEAFOOD,
        "bacon": GroceryCategory.MEAT_SEAFOOD,
        "deli meat": GroceryCategory.MEAT_SEAFOOD,
        "shrimp": GroceryCategory.MEAT_SEAFOOD,
        "salmon": GroceryCategory.MEAT_SEAFOOD,
        # Other / Household
        "paper towels": GroceryCategory.OTHER,
        "toilet paper": GroceryCategory.OTHER,
        "dish soap": GroceryCategory.OTHER,
    }
